(function (superstore) {
  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(title, file, 197, 6, 109980);
  			attr_dev(path, "d", path_d_value = /*getIcon*/ ctx[5](/*$notifications*/ ctx[1].level));
  			add_location(path, file, 198, 6, 110011);
  			...
  			add_location(svg, file, 192, 4, 109849);
  			attr_dev(span, "class", "lh-title ml3");
  			add_location(span, file, 200, 4, 110069);
  			...
  			add_location(div, file, 187, 2, 109692);
  		},
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	return [level, $notifications, message, show, dismiss, getIcon];
  }
  ...
  /* src/components/login_header.svelte generated by Svelte v3.22.2 */
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(a, file$1, 189, 4, 109400);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(a0, file$1, 169, 4, 108897);
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 167, 0, 108853);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  function getServer() {
    const server = get(KeySettingsServer, null);
    if (server === null) {
  ...
  /* src/components/user_login.svelte generated by Svelte v3.22.2 */
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(br, file$2, 422, 4, 113185);
  			attr_dev(a, "href", "/welcome.html");
  			add_location(a, file$2, 424, 4, 113209);
  			attr_dev(p, "class", "measure center");
  			add_location(p, file$2, 420, 2, 113123);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(label0, file$2, 378, 8, 111807);
  ...
  function instance$2($$self, $$props, $$invalidate) {
  	...
  	async function handleSubmit() {
  		...
  		save(KeyUserUuid, response.body.user_uuid);
  		save(KeyUserAuthentication, response.body.token);
  		superstore.login("/welcome.html");
  		return;
  	}
  ...
  const installed = get(KeySettingsInstallDefaults, null);
  if (installed === null) {
      clear();
  }
