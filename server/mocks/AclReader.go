...
func (_m *AclReader) HasUserChallengeOwnerAccess(extUUID string, userUUID string) (bool, error) {
	ret := _m.Called(extUUID, userUUID)
...
func (_m *AclReader) HasUserChallengeWriteAccess(extUUID string, userUUID string) (bool, error) {
	ret := _m.Called(extUUID, userUUID)
