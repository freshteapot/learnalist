    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file, 185, 4, 108528);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file, 165, 4, 108025);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 163, 0, 107981);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(title, file$1, 193, 6, 109136);
    			attr_dev(path, "d", path_d_value = /*getIcon*/ ctx[4](/*$notifications*/ ctx[1].level));
    			add_location(path, file$1, 194, 6, 109167);
    			...
    			add_location(svg, file$1, 188, 4, 109005);
    			attr_dev(span, "class", "lh-title ml3");
    			add_location(span, file$1, 196, 4, 109225);
    			...
    			add_location(div, file$1, 183, 2, 108848);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, div, anchor);
    			append_dev(div, svg);
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(cite, file$2, 253, 6, 110031);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 246, 4, 109709);
    			attr_dev(button0, "class", "br3");
    			add_location(button0, file$2, 247, 4, 109751);
    			attr_dev(button1, "class", "br3");
    			add_location(button1, file$2, 248, 4, 109808);
    			add_location(header, file$2, 245, 2, 109696);
    			attr_dev(p, "class", "f5 f4-m f3-l lh-copy measure mt0");
    			add_location(p, file$2, 251, 4, 109950);
    			attr_dev(blockquote, "class", "athelas ml0 mt4 pl4 black-90 bl bw2 b--black");
    			add_location(blockquote, file$2, 250, 2, 109880);
    			add_location(article, file$2, 244, 0, 109684);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 168, 2, 108122);
    		},
    		m: function mount(target, anchor, remount) {
...
//# sourceMappingURL=v1.1586201239365.js.map
