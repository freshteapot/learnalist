(function (superstore) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file, 108, 4, 103745);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file, 89, 4, 103282);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 87, 0, 103238);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(title, file$1, 126, 6, 104542);
    			attr_dev(path, "d", path_d_value = /*getIcon*/ ctx[4](/*$notifications*/ ctx[1].level));
    			add_location(path, file$1, 127, 6, 104573);
    			...
    			add_location(svg, file$1, 121, 4, 104411);
    			attr_dev(span, "class", "lh-title ml3");
    			add_location(span, file$1, 129, 4, 104631);
    			...
    			add_location(div, file$1, 116, 2, 104254);
    		},
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(cite, file$2, 182, 6, 105386);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 175, 4, 105064);
    			attr_dev(button0, "class", "br3");
    			add_location(button0, file$2, 176, 4, 105106);
    			attr_dev(button1, "class", "br3");
    			add_location(button1, file$2, 177, 4, 105163);
    			add_location(header, file$2, 174, 2, 105051);
    			attr_dev(p, "class", "f5 f4-m f3-l lh-copy measure mt0");
    			add_location(p, file$2, 180, 4, 105305);
    			attr_dev(blockquote, "class", "athelas ml0 mt4 pl4 black-90 bl bw2 b--black");
    			add_location(blockquote, file$2, 179, 2, 105235);
    			add_location(article, file$2, 173, 0, 105039);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 97, 2, 103477);
    		},
    		m: function mount(target, anchor, remount) {
    ...
    class Menu extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>button{font-family:inherit;font-size:100%;line-height:1.15;margin:0}button{overflow:visible}button{text-transform:none}button{-webkit-appearance:button}button::-moz-focus-inner{border-style:none;padding:0}button:-moz-focusring{outline:1px dotted ButtonText}.br3{border-radius:.5rem}@media screen and (min-width:30em) and (max-width:60em){}@media screen and (min-width:60em){}</style>`;
...
//# sourceMappingURL=v1.1585598852313.js.map
