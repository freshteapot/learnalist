  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(title, file, 197, 6, 110031);
  			attr_dev(path, "d", path_d_value = /*getIcon*/ ctx[5](/*$notifications*/ ctx[1].level));
  			add_location(path, file, 198, 6, 110062);
  			...
  			add_location(svg, file, 192, 4, 109900);
  			attr_dev(span, "class", "lh-title ml3");
  			add_location(span, file, 200, 4, 110120);
  			...
  			add_location(div, file, 187, 2, 109743);
  		},
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(a, file$1, 189, 4, 109451);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(a0, file$1, 169, 4, 108948);
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 167, 0, 108904);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(br, file$2, 239, 4, 111055);
  			attr_dev(a, "href", "/welcome.html");
  			add_location(a, file$2, 241, 4, 111079);
  			attr_dev(p, "class", "measure center");
  			add_location(p, file$2, 237, 2, 110993);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(label0, file$2, 195, 8, 109681);
