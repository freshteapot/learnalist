(function (superstore) {
    ...
    /* src/components/v1/Slideshow.svelte generated by Svelte v3.21.0 */
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(cite, file$2, 253, 6, 110663);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 246, 4, 110341);
    			attr_dev(button0, "class", "br3");
    			add_location(button0, file$2, 247, 4, 110383);
    			attr_dev(button1, "class", "br3");
    			add_location(button1, file$2, 248, 4, 110440);
    			add_location(header, file$2, 245, 2, 110328);
    			attr_dev(p, "class", "f5 f4-m f3-l lh-copy measure mt0");
    			add_location(p, file$2, 251, 4, 110582);
    			attr_dev(blockquote, "class", "athelas ml0 mt4 pl4 black-90 bl bw2 b--black");
    			add_location(blockquote, file$2, 250, 2, 110512);
    			add_location(article, file$2, 244, 0, 110316);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/v1/Menu.svelte generated by Svelte v3.21.0 */
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$3, 168, 2, 108758);
    		},
    		m: function mount(target, anchor, remount) {
...
//# sourceMappingURL=v1.1588330601690.js.map
