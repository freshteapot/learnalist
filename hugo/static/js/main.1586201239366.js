  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(title, file, 193, 6, 109136);
  			attr_dev(path, "d", path_d_value = /*getIcon*/ ctx[4](/*$notifications*/ ctx[1].level));
  			add_location(path, file, 194, 6, 109167);
  			...
  			add_location(svg, file, 188, 4, 109005);
  			attr_dev(span, "class", "lh-title ml3");
  			add_location(span, file, 196, 4, 109225);
  			...
  			add_location(div, file, 183, 2, 108848);
  		},
  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(a, file$1, 185, 4, 108528);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(a0, file$1, 165, 4, 108025);
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div, file$1, 163, 0, 107981);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(br, file$2, 235, 4, 110132);
  			attr_dev(a, "href", "/welcome.html");
  			add_location(a, file$2, 237, 4, 110156);
  			attr_dev(p, "class", "measure center");
  			add_location(p, file$2, 233, 2, 110070);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_if_block$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(label0, file$2, 191, 8, 108758);
...
//# sourceMappingURL=main.1586201239366.js.map
