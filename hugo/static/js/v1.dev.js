...
function instance$2($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<Recall> was created with unknown prop '${key}'`);
	});
...
class Recall extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { data: 12 });
...
class View extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { data: 1, speed: 2 });
...
class V1 extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*listElement*/ ctx[9] === undefined && !("listElement" in props)) {
			console.warn("<V1> was created without expected prop 'listElement'");
		}

		if (/*playElement*/ ctx[10] === undefined && !("playElement" in props)) {
			console.warn("<V1> was created without expected prop 'playElement'");
		}
	}
...
function instance$5($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Total_recall> was created with unknown prop '${key}'`);
	});

	let { $$slots = {}, $$scope } = $$props;
	validate_slots("Total_recall", $$slots, []);
...
class Total_recall extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
function instance$6($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<V1> was created with unknown prop '${key}'`);
	});
...
class V1$1 extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$6, create_fragment$6, safe_not_equal, { listElement: 5, playElement: 6, aList: 7 });
		...
		if (/*listElement*/ ctx[5] === undefined && !("listElement" in props)) {
			console_1$2.warn("<V1> was created without expected prop 'listElement'");
		}

		if (/*playElement*/ ctx[6] === undefined && !("playElement" in props)) {
			console_1$2.warn("<V1> was created without expected prop 'playElement'");
		}

		if (/*aList*/ ctx[7] === undefined && !("aList" in props)) {
			console_1$2.warn("<V1> was created without expected prop 'aList'");
		}
	}
...
class Slideshow_1 extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
function instance$9($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<Interact> was created with unknown prop '${key}'`);
	});

	let { $$slots = {}, $$scope } = $$props;
	validate_slots("Interact", $$slots, []);
...
class Interact extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
// Webcomponent
customElements.define('v1-menu', Menu_wc);
