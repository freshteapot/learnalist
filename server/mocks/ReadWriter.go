...
func (_m *ReadWriter) GetUniqueListsByUserAndLabel(_a0 string, user string) ([]string, error) {
...
func (_m *ReadWriter) GetUserLabels(uuid string) ([]string, error) {
	ret := _m.Called(uuid)
...
func (_m *ReadWriter) PostAlistLabel(_a0 *label.AlistLabel) (int, error) {
	ret := _m.Called(_a0)
...
func (_m *ReadWriter) PostUserLabel(_a0 *label.UserLabel) (int, error) {
	ret := _m.Called(_a0)
...
func (_m *ReadWriter) RemoveLabelsForAlist(uuid string) error {
	ret := _m.Called(uuid)
...
func (_m *ReadWriter) RemoveUserLabel(_a0 string, uuid string) error {
